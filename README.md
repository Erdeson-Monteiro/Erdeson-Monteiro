...
<div align="center">
  <h1>Erdeson Monteiro</h1>
  <h3>Desenvolvedor Full Stack em Formação | Backend com Laravel & PHP</h3>

  <p>
    Desenvolvedor focado na construção de aplicações web modernas, APIs bem estruturadas e sistemas escaláveis.<br>
    Estudante de Análise e Desenvolvimento de Sistemas com experiência prática em ambiente profissional.
  </p>
...
- Integração frontend (Next.js) com backend
- Estruturação de sistemas multi-tenant
