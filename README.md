...
\<img src="[https://img.shields.io/badge/Read\_in\_English-Blue?style=for-the-badge&logo=google-translate&logoColor=white](https://img.shields.io/badge/Read_in_English-Blue?style=for-the-badge\&logo=google-translate\&logoColor=white)" alt="Read in English">
...
\<a href="[https://github.com/Erdeson-Monteiro](https://github.com/Erdeson-Monteiro)">
...
- Integração frontend (Next.js/TypeScript) com backend

- Estruturação e manutenção de sistemas multi-tenant e multilíngues

- Construção de componentes de UI reutilizáveis (Tailwind CSS, shadcn/ui, Radix)
...
Instituto Federal do Maranhão (IFMA) — São Raimundo das Mangabeiras
...
Acredito que tecnologia é uma ferramenta de transformação real.

Meu foco é desenvolver sistemas organizados, escaláveis e de fácil manutenção.



Sigo três princípios:

- **Clareza:** Código limpo e legível é prioridade.

- **Evolução contínua:** Estudo constante e melhoria progressiva.

- **Responsabilidade técnica:** Entregar soluções estáveis e bem estruturadas.
